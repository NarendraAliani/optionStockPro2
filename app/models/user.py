...
class User(UserMixin, db.Model):
    ...
    live_fast_mode_enabled = db.Column(db.Boolean, nullable=False, default=True)
    live_fast_max_stocks = db.Column(db.Integer, nullable=False, default=60)
    live_fast_max_strikes_per_stock = db.Column(db.Integer, nullable=False, default=24)
    ...
    telegram_cycle_summary_enabled = db.Column(db.Boolean, nullable=False, default=True)
    telegram_cycle_summary_mode = db.Column(db.String(20), nullable=False, default='short')
    telegram_cycle_summary_channel_id = db.Column(db.String(64))
